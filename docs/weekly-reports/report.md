...
1. [done] Everyone: Set up GitHub Classroom repository
2. [done] Everyone: Configure branch protection rules
3. [done] Everyone: Set up GitHub Projects board

# Week 4 (04/20/2026-04/26/2026)
**Planning and Progress Tracking**:
1. [done] Everyone: Research Risk rules and review example project
2. [done] Everyone: Review project grading rubrics and weekly guidelines
3. [not started] Jonathan: Design document in docs/design/
4. [not started] Justin: User stories and acceptance criteria on GitHub Projects board
5. [not started] Prashant: Game Setup Phase implementation
6. [not started] David: Game Setup Phase implementation

# Week 5 (04/27/2026-05/03/2026)
**Planning and Progress Tracking**:
1. [in progress] Jonathan: Draft initial design document outlining classes and methods for Game Setup Phase
...
5. [done] Jonathan Complete TDD and implementation based on BVA and design document
...
5. [not started] David: Implement BVA and TDD for one turn of Risk
6. [not started] Jonathan: Set up Checkstyle and SpotBugs
2. [not started] Jonathan: Set up Jacoco for code coverage
3. [not started] Jonathan: Set up Pitest for mutation testing
